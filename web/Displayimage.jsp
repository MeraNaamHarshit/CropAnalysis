        ...
        <%
            try {
                ...
                while (rs.next()) {
                    ...
                    String imageFilePath1 = "C:/Users/DELL/Documents/NetBeansProjects/WebApplication2/web/images" + imageFileName1;
                    String imageFilePath2 = "C:/Users/DELL/Documents/NetBeansProjects/WebApplication2/web/images" + imageFileName2;
